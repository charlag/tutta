...
public class AlarmNotification {
    ...
    public Date getEventStartDec(Cryptor crypto, byte[] sessionKey) throws CryptoException {
        return NotificationUtil.decryptDate(this.eventStart, crypto, sessionKey);

    }

    public Date getEventEndDec(Cryptor crypto, byte[] sessionKey) throws CryptoException {
        return NotificationUtil.decryptDate(this.eventEnd, crypto, sessionKey);

    }

    public String getSummaryDec(Cryptor crypto, byte[] sessionKey) throws CryptoException {
        return NotificationUtil.decryptString(this.summary, crypto, sessionKey);
    }
    ...
    public static class NotificationSessionKey {
        ...
        public static NotificationSessionKey fromJson(JSONObject jsonObject) throws JSONException {
            ...
            return new NotificationSessionKey(
                    new IdTuple(new GeneratedId(id.getString(0)), new GeneratedId(id.getString(1))),
