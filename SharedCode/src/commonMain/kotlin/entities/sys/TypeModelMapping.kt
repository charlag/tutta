...
val typeInfos = listOf(
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "alarmNotifications" to Association(
                    type = AGGREGATION,
                    cardinality = Any,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "bucketPermissions" to Association(
                    type = LIST_ASSOCIATION,
                    cardinality = One,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "createGroupData" to Association(
                    type = AGGREGATION,
                    cardinality = ZeroOrOne,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "catchAllMailGroup" to Association(
                    type = ELEMENT_ASSOCIATION,
                    cardinality = ZeroOrOne,
                    refType = "Group",
                    final = false,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "invalidDnsRecords" to Association(
                    type = AGGREGATION,
                    cardinality = Any,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "emailSenderList" to Association(
                    type = AGGREGATION,
                    cardinality = Any,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "administratedGroups" to Association(
                    type = AGGREGATION,
                    cardinality = ZeroOrOne,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "mailAddressAliases" to Association(
                    type = AGGREGATION,
                    cardinality = Any,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "externalUserAreaGroupInfos" to Association(
                    type = AGGREGATION,
                    cardinality = ZeroOrOne,
                    refType = "UserAreaGroups",
                    final = true,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "currentPriceNextPeriod" to Association(
                    type = AGGREGATION,
                    cardinality = ZeroOrOne,
                    refType = "PriceData",
                    final = false,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "bucketPermission" to Association(
                    type = LIST_ELEMENT_ASSOCIATION,
                    cardinality = One,
                    refType = "BucketPermission",
                    final = false,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "variableAuthInfo" to Association(
                    type = ELEMENT_ASSOCIATION,
                    cardinality = One,
    ...
    TypeInfo(
        ...
        TypeModel(
            ...
            associations = mapOf(
                "bootstrapCustomizations" to Association(
                    type = AGGREGATION,
                    cardinality = Any,
